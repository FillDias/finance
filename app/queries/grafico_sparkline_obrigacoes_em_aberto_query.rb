# ObrigacoesEmAbertoQuery é uma foto do agora (Obrigações ainda não pagas) —
# não dá pra recalcular retroativamente o que estava em aberto em meses
...
class GraficoSparklineObrigacoesEmAbertoQuery < ApplicationQuery
